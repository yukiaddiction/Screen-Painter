...
public static class ShellHelper
{
    ...
    public static Task<string?> DisplayPromptAsync(string title, string message, string accept = "OK", string cancel = "Cancel", string? placeholder = null, Keyboard? keyboard = null, string? initialValue = null)
        => Shell.Current?.DisplayPromptAsync(title, message, accept, cancel, placeholder, AppConstants.PromptMaxLength, keyboard, initialValue ?? string.Empty) ?? Task.FromResult<string?>(null);
